            ...
            <div className="bg-white rounded-2xl p-8 shadow-[0_7px_14px_#EAEAEA] border border-[#F1F1F1]">
              ...
              <div className="text-[#010D3E]/80 leading-relaxed space-y-2">
                <div className="flex justify-between">
                  ...
                  <span className="text-[#001E80]">30 Oct, 2024</span>
                </div>
                <div className="flex justify-between">
                  <span className="font-medium">Notification:</span>
                  <span className="text-[#001E80]">5 Nov, 2024</span>
                </div>
                <div className="flex justify-between">
                  <span className="font-medium">Camera Ready:</span>
                  <span className="text-[#001E80]">8 Nov, 2024</span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-[#001E80]">29-30 Nov, 2024</span>
                </div>
              </div>
            </div>
          </div>
