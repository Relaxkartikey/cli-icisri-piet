...
export const metadata: Metadata = {
  ...
  description: "Access conference reports, research publications, and proceedings from ICISRI 2026. Submit your reports and explore published research in intelligent systems, semiconductors, robotics, and IoT.",
  keywords: [
    "Conference Reports",
