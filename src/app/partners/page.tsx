...
export const metadata: Metadata = {
  ...
  description: "Discover our esteemed partners supporting ICISRI 2024. Meet our technical partners, publication partners, and organizing partners who make this international conference possible.",
  keywords: [
    "Conference Partners",
    "Technical Partners",
